...
<template>
    <div id="app" class=" text-white min-vh-100 p-3">
        <!-- FILTER SECTION -->
        <div>
            <h4 class="mb-3 border-start border-primary ps-2" style="color: black;">Diễn Viên </h4>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <!-- NOW SHOWING SECTION -->
                <div>
                    <h5 class="border-start border-primary ps-2 mb-3" style="color: black;">PHIM ĐANG CHIẾU</h5>
