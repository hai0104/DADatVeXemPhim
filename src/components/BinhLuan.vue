...
<template>
    <div id="app" class=" text-white min-vh-100 p-3">
        <!-- FILTER SECTION -->
        <div>
            <h4 class="mb-3 border-start border-primary ps-2" style="color: black;">Bình luận </h4>
            <div class="row g-2 mb-4">
                <div class="col-md-2">
                    <select class="form-select" v-model="filters.country">
                        <option disabled value="">Tất Cả</option>
                ...
                <div class="col-md-3">
                    <select class="form-select" v-model="filters.sort">
                        <option disabled value="">Mới Nhất </option>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card bg-secondary text-white mb-4">
                    <div class="card-header bg-primary" style="color: black;">Mua Vé Nhanh</div>
                    <div class="card-body">
                ...
                <!-- NOW SHOWING SECTION -->
                <div>
                    <h5 style="color: black;">PHIM ĐANG CHIẾU</h5>
